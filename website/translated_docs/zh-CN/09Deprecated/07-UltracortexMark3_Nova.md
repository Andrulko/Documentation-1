...
* (**1x**) An [OpenBCI 32bit Board](02Cyton/01-CytonBoard.md) or an [OpenBCI 16-channel R&D Kit](01GettingStarted/01-Boards/011-Daisy_Getting_Started_Guide.md)
...
* [BOARD_HOLDER](https://github.com/OpenBCI/Ultracortex/blob/master/Mark_III_Nova_REVISED/STLs/HOLDER_AND_COVER/BOARD_HOLDER.stl) — [.STL download link](https://github.com/OpenBCI/Ultracortex/raw/master/Mark_III_Nova/STLs/HOLDER_AND_COVER/BOARD_COVER_STANDARD.stl) ![image](assets/DepImages/BOARD_HOLDER.jpg)
...
![image](assets/DepImages/printedParts.jpg) ![image](assets/DepImages/bolts_screws_springs_trodes.jpg)
...
![image](assets/DepImages/Spring_S-845.png)
...
#### (1x) An [OpenBCI 32bit Board](02Cyton/01-CytonBoard.md) (8 electrode channels) or an [OpenBCI 16-channel R&D Kit](01GettingStarted/01-Boards/011-Daisy_Getting_Started_Guide.md) (16 electrode channels)
...
![image](assets/DepImages/cleanup1.JPG) ![image](assets/DepImages/cleanup3.JPG)
...
![image](assets/DepImages/drilling_frame.jpg)
...
![image](assets/DepImages/comfortnodeparts.jpg)

First, put the comfort insert into front of the ELECTRODE_HOLDER. ![image](assets/DepImages/comfortinsert_electrodeholder.jpg)

Next, insert the spring into the back of the ELECTRODE_HOLDER. ![image](assets/DepImages/spring_electrodeholder.jpg)


Then, slide the OCTABOLT over the top: ![image](assets/DepImages/OCTABOLT_comfort1.jpg) ![image](assets/DepImages/OCTABOLT_comfort2.jpg)
...
![image](assets/DepImages/glue_octanut.jpg)
...
![image](assets/DepImages/screw_board.jpg)
...
The images below indicates the default 10-20 electrode locations that the OpenBCI Graphical User Interface expects. This application is great for viewing/recording your EEG and can be found in our [OpenBCI_Processing](https://github.com/OpenBCI/OpenBCI_GUI/tree/master/OpenBCI_GUI) repo. The blue nodes indicate the 8 default 10-20 locations (channels 1-8) of the 32bit Board. The red nodes indicate the default 10-20 locations of channels 9-16 when using the OpenBCI 16-channel R&D Kit.
...
![image](assets/DepImages/STRIP_WIRE1.jpg)

![image](assets/DepImages/STRIP_WIRE2.jpg)

![image](assets/DepImages/STRIP_WIRE3.jpg)

![image](assets/DepImages/STRIP_WIRE4.jpg)
...
These are the pieces that comprise one full electrode unit: ![image](assets/DepImages/electrode_hardware_parts.jpg)
...
Then, slide the screw and electrode into the ELECTRODE_HOLDER ![image](assets/DepImages/inserttrode.jpg)

Next, twist a *Hex Nut (2-56 Thread Size, 3/16" Wide, 1/16" High)* onto the screw, securing the electrode to the holder. ![image](assets/DepImages/fastenNut.jpg)
...
![image](assets/DepImages/twistWire3.jpg) ![image](assets/DepImages/twistWire4.jpg)
...
![image](assets/DepImages/INSERT_ELECTRODES.png)
...
![image](assets/DepImages/supernova_parts.jpg)
...
Take your QUADSTAR and stretch it so that it fits over the OCTARING ![image](assets/DepImages/stretch_quadstar1.jpg) ![image](assets/DepImages/stretch_quadstar2.jpg)
...
![image](assets/DepImages/tiedown1.jpg) ![image](assets/DepImages/tiedown3.jpg) ![image](assets/DepImages/tiedown2.jpg) ![image](assets/DepImages/tiedown_complete.jpg)

### Cut Zip Ties

Turn the ULTRACORTEX over and snip off all of the loose ends of the zip ties.

![image](assets/DepImages/snip_zipties.jpg)

### Insert Comfort Nodes

Next, screw a comfort node into each of the 8 QUADSTARS.

![image](assets/DepImages/screw_comforts.jpg)


### Supernova Assembly Complete!
![image](assets/DepImages/supernova_complete.jpg)
...
![image](assets/DepImages/WEARING_IT2.jpg)

Check out the [Getting Started w/ OpenBCI tutorial](01GettingStarted/00-GettingStartedLanding.md) to get up-and-running with the [OpenBCI Processing GUI](https://github.com/OpenBCI/OpenBCI_Processing).

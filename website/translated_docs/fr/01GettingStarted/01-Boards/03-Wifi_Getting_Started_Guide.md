...
### What you need
 ...
 2. OpenBCI Cyton Board **Must have at least [v3.1.0 Cyton firmware](https://github.com/OpenBCI/OpenBCI_32bit_Library/releases) or newer!** Here is the guide for [uploading new firmware to your Cyton Board](02Cyton/05-Cyton_Board_Programming_Tutorial.md).
...
![iPhone Connecting to <code>OpenBCI-A4AD</code>](assets/GettingStartedImages/wifi_join_network_2.PNG)

Your phone or computer will connect to the WiFi Shield's hotspot.

![iPhone Connected to <code>OpenBCI-E218</code>](assets/GettingStartedImages/wifi_joined_network.png)

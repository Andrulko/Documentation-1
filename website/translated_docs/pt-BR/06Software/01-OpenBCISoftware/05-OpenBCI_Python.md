...
The [Ganglion](https://shop.openbci.com/collections/frontpage/products/pre-order-ganglion-board) has 4 channels, meaning the Ganglion can take four simultaneous voltage readings.

The [Cyton](https://shop.openbci.com/collections/frontpage/products/cyton-biosensing-board-8-channel) has 8 channels and [Cyton with Daisy](https://shop.openbci.com/collections/frontpage/products/cyton-daisy-biosensing-boards-16-channel) has 16 channels.
